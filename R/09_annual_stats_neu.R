...
evap_neu <- readRDS("data/tabular/evap_1980_2023_neu.rds")
...
# drop all pixels falling below 34 ( our focus is EUneuiterranean region)
...
saveRDS(annual_stats, "data/processed/annual_stats_neu.rds")

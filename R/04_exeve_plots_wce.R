...
annual_summary_long   <- readRDS("data/processed/annual_summary_wce.rds")
annual_intensity_long <- readRDS("data/processed/annual_intensity_wce.rds")
extreme_wide          <- readRDS("data/processed/extreme_ratio_annual_wce.rds")
monthly_ratio_summary <- readRDS("data/processed/monthly_ratio_wce.rds")

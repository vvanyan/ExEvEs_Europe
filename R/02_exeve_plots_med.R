...
## Phase 2 – Plotting for ExEvEs Analysis
## Requires RDS outputs from 01_med_exeve_phase1.R:
##   annual_summary_med.rds
##   annual_intensity_med.rds
##   extreme_ratio_annual_med.rds
##   monthly_ratio_med.rds.rds
...
# this is useful when you need to make your codes clean and short 
# now only I have base_theme in there you can think about alternatives as well such as defining 
# start period, end period, path of the files etc)

## Load data

annual_summary_long   <- readRDS("data/processed/annual_summary_med.rds")
annual_intensity_long <- readRDS("data/processed/annual_intensity_med.rds")
extreme_wide          <- readRDS("data/processed/extreme_ratio_annual_med.rds")
monthly_ratio_summary <- readRDS("data/processed/monthly_ratio_med.rds")
...
ggsave(
  filename = "results/figure/med_summary.pdf",
  plot     = p_all,
  width    = 16,
  height   = 12,
  dpi      = 600
